    ...
    public partial class update1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrderInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserOrderInformations_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_UserOrderInformations_UserOrderInfoId",
                        column: x => x.UserOrderInfoId,
                        principalTable: "UserOrderInformations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_UserOrderInfoId",
                table: "Orders",
                column: "UserOrderInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrderInformations_UserId",
                table: "UserOrderInformations",
                column: "UserId");
        }
